...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
    ...
    // Authentication...
    if ($enableViews) {
        Route::get(RoutePath::for('signin', '/signin'), [AuthenticatedSessionController::class, 'create'])
    ...
    Route::post(RoutePath::for('signin', '/signin'), [AuthenticatedSessionController::class, 'store'])
